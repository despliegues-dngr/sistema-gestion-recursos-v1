...
### **REGLA 4: CONCISIÓN OBLIGATORIA**

✅ Las respuestas deben ser **detalladas pero concisas**
✅ **PROHIBIDO:** Texto de relleno, redundancias, explicaciones excesivamente largas
✅ **REQUERIDO:** Información precisa, directa al punto, sin rodeos

**Principios de concisión:**
- Cada párrafo debe aportar valor nuevo
- Preferir listas cortas sobre párrafos largos
- Si algo se puede decir en 1 línea, no usar 3
- Eliminar frases de cortesía innecesarias
- Ir directo a la solución/respuesta

**Formato ideal:**
```
[Respuesta directa al problema]
[Detalles técnicos necesarios - solo los esenciales]
[Próximo paso claro]
```
